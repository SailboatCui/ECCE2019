...
%%  Model 1 Step Response
z1= 1-T/r/c;
g= Toff/c*lambda-Vout/m1/r/c;
z0= (-Vout/m1/r-Toff*(1-lambda))/(-Vout/m1/r+Toff*lambda);
Lz1 = (g*(z-z0)/(z-z1)/z)
...
rangec = 90;
mp3 = stairs(1:rangec,y1(1:rangec)','linewidth',1.5);                 % Plot simulation data

%t = title({'Model Accuracy Comparision','\lambda = 0.1 (under 1V step up)'});
set(t,'FontSize',10,'FontName','Arial');

lg=legend([mp3],'Model I','Location','Best');
